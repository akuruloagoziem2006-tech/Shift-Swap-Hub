...
export default function Home() {
  return (
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center gap-3 group">
              <div className="size-10 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg shadow-blue-500/25 group-hover:shadow-blue-500/40 transition-shadow">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <Link href="/auth">
                <Button className="bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 shadow-lg shadow-blue-500/20 font-medium">
                  Try Demo
                </Button>
              </Link>
            </div>
      ...
      <section className="pt-32 pb-20 sm:pt-40 sm:pb-28 px-4 sm:px-6 relative">
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/auth">
              <Button size="lg" className="w-full sm:w-auto bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 px-8 h-12 text-base font-semibold shadow-xl shadow-blue-500/25 group">
                Try Demo Free
      ...
      {/* Features Overview */}
      <section id="features" className="py-20 sm:py-28 px-4 sm:px-6 border-y border-border/50 bg-gradient-to-b from-transparent via-blue-500/[0.02] to-transparent">
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-20 sm:py-28 px-4 sm:px-6 bg-gradient-to-b from-transparent via-blue-500/[0.02] to-transparent">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
          ...
          <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
            ...
            {/* Team */}
            <div className="relative p-8 rounded-2xl bg-gradient-to-b from-blue-500/10 to-indigo-500/5 border-2 border-blue-500/50 shadow-xl shadow-blue-500/10">
              <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-4 py-1 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full text-xs font-semibold text-white shadow-lg">
                Most Popular
              </div>
              ...
              <Link href="/auth" className="block">
                <Button className="w-full bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 font-medium">Start Free Trial</Button>
              </Link>
            </div>
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6">
        <div className="max-w-3xl mx-auto text-center">
          <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-indigo-600 to-blue-700 rounded-3xl p-10 sm:p-14 shadow-2xl shadow-blue-500/20">
            {/* Decorative elements */}
            ...
            <div className="relative">
              ...
              <Link href="/auth">
                <Button size="lg" className="bg-white text-blue-700 hover:bg-blue-50 px-10 h-12 text-base font-semibold shadow-xl group">
                  Try Demo Free
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            ...
            <div className="col-span-2 md:col-span-1">
              <Link href="/" className="flex items-center gap-3 mb-4">
                <div className="size-9 rounded-lg bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center shadow-lg shadow-blue-500/20">
