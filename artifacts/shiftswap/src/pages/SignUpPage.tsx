  ...
  if (emailSent) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-zinc-950 px-4">
        <div className="w-full max-w-md bg-zinc-900 rounded-3xl border border-zinc-800 p-8 text-center space-y-4">
          ...
          <Link to="/sign-in">
            <Button variant="outline" className="w-full py-6 rounded-xl border-zinc-700 text-zinc-300 hover:bg-zinc-800">
              Back to sign in
            </Button>
          </Link>
        </div>
        ...
        <div className="bg-zinc-900 rounded-3xl border border-zinc-800 p-8 space-y-6">
          <div className="flex flex-col items-center gap-4 mb-2">
            ...
            <div className="text-center">
              ...
              <p className="text-zinc-400 mt-2">Free to join. No credit card required.</p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs text-zinc-500">
              <span className="bg-zinc-900 px-3">or sign up with email</span>
            </div>
          </div>
          ...
          <p className="text-center text-xs text-zinc-500">
            ...
            <Link to="/sign-in" className="text-teal-400 hover:text-teal-300 underline underline-offset-2">
              Sign in
            </Link>
          </p>
        </div>
